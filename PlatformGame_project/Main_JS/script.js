...
class Platform {
    constructor(x, y) {
        ...
        this.width = 200;
        this.heigth = proportionalSize(40);
    }
    draw() {
...
const animate = () => {
    ...
    platforms.forEach((platform) => {
        const collisionDetectionRules = [
            player.position.x + player.height <= platform.position.y,
        ...
        const platformDetectionRules = [
            ...
            player.position.y <= platform.position.y + platform.heigth,
        ];
